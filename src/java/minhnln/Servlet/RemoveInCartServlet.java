 ...
 * @author Welcome
 */
@WebServlet(name = "RemoveInCartServlet", urlPatterns = {"/RemoveInCartServlet"})
public class RemoveInCartServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            log("Error at RemoveInCartServlet:" + e.getMessage());
        } finally {
