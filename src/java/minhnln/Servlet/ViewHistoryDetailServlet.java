...
public class ViewHistoryDetailServlet extends HttpServlet {
    ...
    final private String HISTORYDETAIL_PAGE = "historydetail.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String rentalID = request.getParameter("txtRentalID");
        try {
            HttpSession session = request.getSession();
            if (session.getAttribute("ROLE") != null) {
                RentalDetailDAO RDdao = new RentalDetailDAO();
                List<RentalDetailDTO> list = RDdao.getDetailbyRentalID(rentalID);
                request.setAttribute("DETAILRENTALLIST", list);
